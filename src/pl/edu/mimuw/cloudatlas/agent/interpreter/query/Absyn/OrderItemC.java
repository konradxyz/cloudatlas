...
public class OrderItemC extends OrderItem {
  ...
  public <R,A> R accept(pl.edu.mimuw.cloudatlas.agent.interpreter.query.Absyn.OrderItem.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof pl.edu.mimuw.cloudatlas.agent.interpreter.query.Absyn.OrderItemC) {
      pl.edu.mimuw.cloudatlas.agent.interpreter.query.Absyn.OrderItemC x = (pl.edu.mimuw.cloudatlas.agent.interpreter.query.Absyn.OrderItemC)o;
