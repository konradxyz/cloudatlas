...
public abstract class SelItem implements java.io.Serializable {
  ...
  public interface Visitor <R,A> {
    public R visit(pl.edu.mimuw.cloudatlas.agent.interpreter.query.Absyn.SelItemC p, A arg);
    public R visit(pl.edu.mimuw.cloudatlas.agent.interpreter.query.Absyn.AliasedSelItemC p, A arg);
