...
public class CondExprAndC extends CondExpr {
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof pl.edu.mimuw.cloudatlas.agent.interpreter.query.Absyn.CondExprAndC) {
      pl.edu.mimuw.cloudatlas.agent.interpreter.query.Absyn.CondExprAndC x = (pl.edu.mimuw.cloudatlas.agent.interpreter.query.Absyn.CondExprAndC)o;
