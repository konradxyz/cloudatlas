...
public class MinTest extends AggregationTest {
	...
	public void fillTests() {
		...
		prepareTestFromStrings(new String[] { "+0 12:05:10.120",
				...
				new ValueDuration("-1 10:05:10.120"));
